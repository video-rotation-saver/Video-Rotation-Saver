<img width="1800" height="720" alt="logo-horizontal-clean" src="https://github.com/user-attachments/assets/fbe9efa4-6602-4e46-bdbe-1f5774250915" />

# Video Rotation Saver

## Download

Get the latest Windows installer from the [GitHub Releases page](https://github.com/video-rotation-saver/Video-Rotation-Saver/releases/latest). Most users should download `VideoRotationSaver-Setup-1.0.0.exe`.
